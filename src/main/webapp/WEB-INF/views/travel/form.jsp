...
<form action="${pageContext.request.contextPath}/travel/result">
    ...
    <p>
        <label>교통비 : <input type="number" name="transportationCost"/></label>
    </p>
    <p>
        <label>음식비 : <input type="number" name="foodCost"/></label>
    </p>
    <p>
        <label>기타 : <input type="number" name="additionalCosts"/></label>
    </p>
    <p>
        <label>인원 : <input type="number" name="headCount"/></label>
    </p>
    <p>
